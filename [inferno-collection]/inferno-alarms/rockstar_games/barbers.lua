...
-- Generated with the Inferno Fire Alarm Reborn Tool 11/06/2024 02:42:07 UTC
...
system { name = "Barber - Carson Ave", location = "Carson Ave, Davis", position = vec3(134.78, -1709.438, 29.292) }
    ...
    sounder { position = vec3(141.22, -1705.224, 30.92), rotation = vec3(0, 0, 140), virtual = false }

    strobe { position = vec3(142.044, -1705.915, 30.928), rotation = vec3(0, 0, 140), virtual = false }
...
system { name = "Barber - Alhambra Dr", location = "Alhambra Dr, Sandy Shores", position = vec3(1932.741, 3727.277, 32.844) }
    ...
    sounder { position = vec3(1930.479, 3735.263, 34.48), rotation = vec3(0, 0, -149.979), virtual = false }

    strobe { position = vec3(1931.451, 3735.824, 34.489), rotation = vec3(0, 0, -149.979), virtual = false }
